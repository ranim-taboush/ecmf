...
const Services = ({ }) => {
  ...
  const [currentLine, setCurrentLine] = useState(lines[params?.index || 0]);
  ...
  return <div>
    ...
    <div className="relative -mt-60 max-lg:-mt-20 container bg-[#F9F9F9] rounded-lg px-8 sm:px-16 py-6 sm:py-12 z-10">
