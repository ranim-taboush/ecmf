export const info = {
    "Sigal Ornaments": {
        data: `<h2 dir="rtl" style="text-align: right;"><strong><span style="font-size:16pt;">كمر حديد سيجال:</span></strong></h2>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">احصل على كمر حديد سيجال بكل انواعه حيث تم صناعته بإستخدام أحدث التقنيات بفضل تكنولوجيا التصنيع المتقدمة التي نعتمدها. يتميز كمر حديد سيجال بمقاومة عالية للصدأ والتآكل، مما يضمن لك أداء قوى حتى في ظروف العمل القاسية.</span></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">انواع الكمر:</span></strong></h3>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">&nbsp;- كمر مجري:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمر مجري هو نوع من أنواع كمر الحديد على شكل U هيكلي مصنوع من الفولاذ الطري المدلفن على الساخن مع زوايا نصف قطر داخلية. مثالى للعديد من التطبيقات الهيكلية، البناءات والهندسة المدنية. قناة صلب الكمر المجري تتميز إنها على نطاق واسع حيث تستخدم في الصيانة الصناعية والأدوات الزراعية ونقل المعدات، والمقطورات.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتكون كمر المجري عادةً من لوحات معدنية أو قضبان معدنية تمتد عبر فتحة الجسر أو النفق، يتم تركيبه بشكل مائل لتوجيه التدفق بشكل فعال لتعزيز البنية التحتية للجسور والأنفاق. بالإضافة إلى إنه يقوم بتوجيه مياه الأمطار ومياه الصرف الصحي والسوائل الأخرى بعيدًا عن الهياكل الرئيسية للجسور والأنفاق، وبالتالي تحسين الأداء والمتانة الإنشائية للجسور والأنفاق.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">- كمر متوازي:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الكمر المتوازي هو عباره عن قطعه معدنيه لها جانبين صغيرين كما انه يرمز له بIPN/IPE يستخدم دائما في البناء و التشييد وله تطبيقات مهمة في مجال الهندسة المعمارية و الميكانيكية. يتم استخدامه في اعمال التشيد والبناء ويكون على شكل حرف I.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كما أنه عنصر مهم يستخدم في البناءات والهندسة المدنية لتعزيز وتقوية المباني والإنشاءات. يتميز الكمر المتوازي بتصميم يتكون من قضبان متوازية موازية لبعضها البعض. يتم استخدام الكمر المتوازي في الأعمال الإنشائية وغيرها من المشاريع التي تتطلب دعم هيكلي قوي ومتساوي. يمكن أن يكون الكمر المتوازي جزءً من الأسقف، أو الأعمدة، أو الجدران، حيث يوفر دعم إضافي ويقلل من انحناءات المباني وتشوهها.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">- كمر إنجليزي:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمر إنجليزي هو عبارة عن عنصر هيكلي يستخدم في البناءات والهندسة المدنية. يتكون من قضبان من الحديد أو الصلب متصلة بقطعة عرضية في الأعلى، وتكون هذه القطعة العرضية موازية للأرض حيث إنها تعمل على دعم الهيكل الفوقي، سواء كانت ذلك أعمدة أو جدران أو أي عناصر بنائية أخرى.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتم استخدام الكمر الإنجليزي في العديد من التطبيقات، بما في ذلك البناءات السكنية والتجارية والصناعية، والجسور، والأنفاق، وغيرها من المشاريع الإنشائية. يتوفر الكمر الإنجليزي بمختلف الأحجام والتصاميم لتناسب احتياجات كل مشروع محدد ويتم استخدامه لتقديم دعم إضافي وتقوية الهياكل البنائية وتحسين استقرارها بشكل أمن.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">- كمرات المرتكزة:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمرات المرتكزة هي عبارة عن عناصر هيكلية تُستخدم في البناءات الجسرية والإنشائية لتوسيع العرض الهيكلي عبر فتحة أو نقطة دعم معينة. تعتبر كمرات المرتكزة جزء أساسي من تصميم الجسور. كما أن كمر المرتكزة مهم جدا وشائع الاستخدام ويُدعم من طرفيه حيث طرف يتم تثبيته والآخر إما ثابت أو عن طريق استخدام رولر ويتم تثبيت الكمر عن طريق الانحناء والقص.&nbsp;</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">كمرات مرتكزة وثابتة:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمرات مرتكزة وثابتة هي من ضمن أنواع الكمرات الهيكلية التي تستخدم في الهندسة المدنية والبناءات. تتميز هذه الكمرات بأنها مثبتة بشكل ثابت عند نقطتين على الأقل مع تقييد حركة الدوران للكمر ولهذا أطلق عليه الكمر الثابت. يتم تثبيت الكمرات بشكل ثابت في هذه النقاط دون السماح لها بالتحرك أو الاهتزاز في أي أتجاهات سواء أفقية أو رأسية. يتم استخدام كمرات المرتكزة الثابتة في بناء الجسور والهياكل الهندسية الكبيرة حيث تقوم بحمل الأحمال الثقيلة وتوزيعها بشكل صحيح.&nbsp;</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">- كمرات مع كابولي من أحادي الطرف:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتم استخدام كمرات مع كابولي من أحادي الطرف لتوفر الدعم والاستقرار اللازم للهياكل الإنشائية مثل الجسور والأنفاق. توفر الكابولي المثبتة من طرف واحد القوة والصلابة لتحمل الأحمال الثقيلة وتوزيعها بشكل متساوي، بينما يعمل الطرف الآخر كنقطة تثبيت للكمر في الموقع المحدد.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">- كمرات مع كابولي من الطرفين:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمرات مع كابولي من الطرفين دورها تقديم الدعم اللازم للهياكل الإنشائية. &nbsp;كما أن الكمرات صلبة بالإضافة إلى الهيكلية للكابولي، التي تعمل كقوسين يتصلان بنقطة وسطية وتقوم بتوزيع الحمل بشكل متساوي على الهيكل.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">- كمر حديد سيجال:</span></strong></h4>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمر حديد سيجال هو عباره عن قطاعات حديديه من صاج أسود أو صاج مجلفن خفيفه الوزن ويتميز بمقاومة عالية للأحمال والإجهادات. كماأن كمر حديد سيجال يكون على أشكال (C- U- Z ) بكافه الدرجات والصلابات المطلوبة وهي مصنعة بواسطة أحدث تقنيات الصناعة وهى خطوط الدرفله على البارد حيث تستخدم في تثبيت المباني المعدنية وتثبيت التجاليد.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">بالإضافة إلى أن كمر حديد سيجال من أنواع كمر الحديد القوية، وهو مصنوع من الحديد باستخدام عملية تشكيل على البارد. يتم إنتاج كمر حديد سيجال عن طريق تشكيل قضبان الحديد في درجات حرارة الغرفة بدون تسخينها إلى درجات حرارة عالية كما يحدث في عملية التشكيل على الساخن. يتميز كمر حديد سيجال على البارد بسطح نهائي أكثر نعومة بالمقارنة مع الحديد المصنوع على الساخن. ويُستخدم كمر حديد سيجال في صناعة السيارات، والإنشاءات المعدنية، وتصنيع الأجهزة المنزلية، والعديد من الصناعات الأخرى التي تتطلب مواد معدنية بسطح ناعم ومقاوم للتآكل.&nbsp;</span></p>
        <p><br></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">مميزات كمر حديد سيجال:</span></strong></h3>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمر حديد سيجال لديه عده مميزات تجعله خيار شائع في البناء والهندسة المدنية، ومن بين هذه المميزات:</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">1- متانة عالية:&nbsp;</span></strong><span style="font-size:12pt;">كمر سيجال مصنوع من مواد عالية الجودة تمنحه متانة وقوة استثنائية، مما يجعله قادرة على تحمل الضغوط والأحمال الثقيلة في البناءات والهياكل.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">2- مقاومة للصدأ والتآكل:</span></strong><span style="font-size:12pt;">&nbsp;يتم معالجة كمر حديد سيجال بطبقة من المواد المقاومة للصدأ، مما يجعله مقاوم للتآكل بشكل آمن.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">3- سهولة التشكيل والتصنيع:</span></strong><span style="font-size:12pt;">&nbsp;من ضمن مميزات كمر حديد سيجال أنه يمكن بسهولة تشكيله وتصنيعه بأشكال مختلفة لتناسب جميع احتياجات مشاريع البناء المختلفة.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">4- قابلية التوافق:</span></strong><span style="font-size:12pt;">&nbsp;يمكن استخدام كمر سيجال بسهولة مع مواد البناء الأخرى، مما يجعله يتناسب مع مختلف تصميمات المباني والهياكل.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">5- تكلفة منخفضة:</span></strong><span style="font-size:12pt;">&nbsp;بالرغم من جوده كمر سيجال على البارد العالية ومتانته، إلا أن كمر الحديد سيجال عادة ما يكون تكلفته منخفضة مقارنة ببعض الخيارات الأخرى، مما يجعله اختيار اقتصادي ومثالي للعديد من المشاريع.</span></h4>
        <p><br></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">استخدامات كمر الحديد سيجال:</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">كمر الحديد سيجال يُستخدم في مجموعة واسعة من التطبيقات في مجال البناء والهندسة المدنية بسبب مميزاته القوية والمتنوعة التي وضحناها. من بين أبرز استخداماته:</span></p>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">تقوية الهياكل الإنشائية:&nbsp;</span></strong><span style="font-size:12pt;">يتم استخدام كمر الحديد سيجال لتعزيز وتقوية الهياكل الإنشائية مثل الأعمدة والأسقف والجدران للزيادة من قوتها ومتانتها.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">بناء الجسور:</span></strong><span style="font-size:12pt;">&nbsp;كمر سيجال على البارد يُستخدم أيضًا في بناء الجسور لتقديم الدعم اللازم للأجزاء الهيكلية المختلفة مثل الأعمدة والسطح العلوي.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">البناءات الصناعية:&nbsp;</span></strong><span style="font-size:12pt;">يتحمل الأوزان الثقيلة لذلك فهو يُستخدم في بناء المصانع والمنشآت الصناعية.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">المنشآت السكنية والتجارية:</span></strong><span style="font-size:12pt;">&nbsp;يُستخدم كمر الحديد سيجال في بناء المنازل والمباني التجارية لتوفير الدعم اللازم للأسقف والجدران.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">الأعمال الصناعية الثقيلة:</span></strong><span style="font-size:12pt;">&nbsp;يُستخدم كمر سيجال على البارد في كلًا من صناعات النفط والغاز والتعدين والطاقة لتقديم الدعم اللازم للمعدات الثقيلة والهياكل الصناعية.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">بناء السور والأسوار:</span></strong><span style="font-size:12pt;">&nbsp;يتم استخدام كمر الحديد سيجال في بناء السور والأسوار حيث أنه يقدم الدعم والتحصين اللازم للحماية والأمان بشكل مثالي.</span></p>
            </li>
        </ul>
        <p><br></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تواصل معنا الآن لمعرفة المزيد من التفاصيل وأسعارنا المميزة وسيتم المتابعة معك من قبل فريق المبيعات لدينا في أسرع وقت. &nbsp;</span></p>`,
    },
    "Colored Sheet": {
        data: `<h2 dir="rtl" style="text-align: right;"><strong><span style="font-size:16pt;">لوح صاج ملون:</span></strong></h2>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">قبل شراء لوح صاج ملون تأكد من سمك الصاج، عادًة يكون سمك لوح صاج ملون يتراوح بين 0.4 إلى 6 مم.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لكن في حالة أن سمك اللوح أصغر من 0.4 يكون فويل وليس لوح صاج.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح صاج ملون هو نوع من الألواح المعدنية المطلية بطبقة من الطلاء الملون، يوجد العديد من استخدامات لوح صاج ملون ومن بينها:</span></p>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">البناءات والهياكل الصناعية: يستخدم لوح الصاج الملون في تغطية أسطح المباني والمنشآت الصناعية، سواء كانت واجهات خارجية أو سقوف، حيث يضيف مظهر جمالي ويحمي الهيكل من التآكل والعوامل الجوية الصعبة.</span></p>
            </li>
        </ul>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الصناعات الزراعية: يتم استخدام لوح صاج ملون في بناء المستودعات الزراعية والمزارع والأبنية الزراعية الأخرى، حيث أنه يوفر الحماية اللازمة للمعدات والمخزون من التعرض للتآكل بسبب الظروف المناخية المختلفة.</span></p>
            </li>
        </ul>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صناعة السيارات والنقل: كما أن لوح صاج ملون يستخدم لتصنيع أجزاء الهياكل الخارجية للسيارات والحافلات والشاحنات الضخمة، لإضافة مظهر جذاب ولحماية الهيكل الخارجي من حدوث أي تآكل أو صدأ.&nbsp;</span></p>
            </li>
        </ul>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الإعلانات واللوحات الإرشادية: يستخدم في تصنيع اللوحات الإعلانية واللافتات الإرشادية في الطرق والمدن، حيث يمكن استخدام الألوان المختلفة من لوح الصاج لجذب الانتباه وإيصال الرسائل للجمهور بشكل فعال.</span></p>
            </li>
        </ul>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الأثاث الخارجي: له دور ايضًا في تصنيع الأثاث الخارجي مثل الطاولات والكراسي والمظلات، حيث أنه يوفر حماية للأثاث من التآكل.</span></p>
            </li>
        </ul>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">مراحل تصنيع لوح صاج ملون:&nbsp;</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتم تصنيع لوح الصاج الملون عن طريق عملية الدرفلة ويوجد نوعين من الدرفله على البارد وعلى الساخن.&nbsp;</span></p>
        <p><br></p>
        <ul>
            <li><strong>
                    <ul>
                        <p dir="rtl" style="list-style-type:none;">
                            <h4 dir="rtl" style="text-align: right;"><span style="font-size:14pt;">درفلة على الساخن (Hot Rolling):</span></h4>
                        </p>
                    </ul>
                </strong><strong>
                    <ul>
                ...
                <ul>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تتم عملية الدرفلة على درجة حرارة عالية تتراوح بين 1100 إلى 1300 درجة مئوية.</span></p>
                    </li>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتم تشكيل لوح الصاج بشكل أسرع وأسهل بسبل الحرارة العالية.</span></p>
                    </li>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تساعد درجة الحرارة العالية على تحسين قابلية تشكيل المعادن وتقليل التوترات الداخلية والتشققات.</span></p>
                    </li>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تستخدم عملية الدرفلة على الساخن لإنتاج أسطح أكثر سلاسة وتشكيلات متنوعة، والتي تجعلها مناسبة للصناعات التي تتطلب قوة عالية ومتانة.</span></p>
                    </li>
                </ul>
            </li>
        </ul>
        ...
        <ul>
            <li><strong>
                    <ul>
                        <p dir="rtl" style="list-style-type:none;">
                            <h4 dir="rtl" style="text-align: right;"><span style="font-size:14pt;">درفلة على البارد (Cold Rolling):</span></h4>
                        </p>
                    </ul>
                </strong>
                <p><br></p>
                <ul>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تتم عملية الدرفلة على درجة حرارة الغرفة أو درجة حرارة منخفضة.</span></p>
                    </li>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تسمح درجة الحرارة المنخفضة بتشكيل المعادن بدقة عالية وتحسين الخواص الميكانيكية للمواد.</span></p>
                    </li>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتم استخدامها لتحسين السطح والأبعاد النهائية للمنتج، كما أنها تؤدي إلى تقليل سمك المواد بدقة عالية الجودة.</span></p>
                    </li>
                    <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتم استخدام الدرفلة على البارد لإنتاج أوراق وشرائط الصلب الرقيقة، وأيضًا لمنتجات مثل الأنابيب والأسلاك.</span></p>
                    </li>
                </ul>
            </li>
        </ul>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">أشكال لوح صاج ملون:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تذكر أن استخدامات هذه الألواح الملونة قد تختلف باختلاف الصناعة واحتياجات المشروع المحددة، لذلك فهي قد تختلف على حسب الصناعة. فيما يلي اشكال اللوح الصاج المختلفة:</span></p>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح صاج ملون على شكل ألواح.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح صاج ملون ملفوف على شكل رولر.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح صاج ملون ملفوف على شكل رولر خشن.</span></p>
            </li>
        </ul>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">إليك استخدامات لكل نوع من ألواح الصاج الملونة:</span></strong></h3>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">1. لوح صاج ملون على شكل ألواح:&nbsp;</span></strong></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;يُستخدم هذا النوع من الألواح في بناء الهياكل المعدنية الضخمة مثل الأسوار والأبواب والنوافذ. كما يمكن استخدامه في تصنيع الأثاث المعدني مثل الخزائن والطاولات وأيضًا يدخل في صناعة السقوف والجدران للمباني الصناعية والتجارية.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">2. لوح صاج ملون ملفوف على شكل رولر:</span></strong></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; يُستخدم عمومًا في تغطية الأسطح الكبيرة مثل السقوف والجدران الخارجية للمباني لحمايتها من التآكل. بالإضافة إلى انه يُستخدم في الإعلانات الكبيرة واللافتات العامة الموجودة على الطرق، كما يمكن استخدامه في تصنيع الأسطح المعدنية المسطحة مثل الأبواب واللوحات الداخلية.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">3. لوح صاج ملون ملفوف على شكل رولر خشن:</span></strong></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; يسُتخدم في الصناعات التحويلية مثل صناعة الأجهزة المنزلية وأجزاء السيارات ويدخل في تصنيع الأثاث الصناعي والأجزاء الميكانيكية. كما أنه يتم استخدامه في صناعة الحاويات والأوعية الصناعية.</span></p>
        <p><br></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">انواع الصاج:</span></strong></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صاج أسود.&nbsp;</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صاج مجلفن.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صاج استانلس.&nbsp;</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صاج ألمنيوم.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صاج نحاس.</span></p>
            </li>
        </ul>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><span style="font-size:14pt;">إليك استخدامات كل نوع من ألواح الصاج:&nbsp;</span></h3>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">صاج أسود:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يُستخدم في صناعة هياكل السيارات والآلات بسبب قوته ومتانته. كما أنه قد يستخدم في تصنيع أبواب المحلات التجارية بسبب قوته وقدرته على تحمل الاستخدام الثقيل والمستمر.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">صاج مجلفن:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتم استخدام الصاج المجلفن في خزانات المياه ومجاري التكييف بسبب مقاومته للتآكل والصدأ، مما يجعله مثالي لتخزين المياه واستخدامه في أنظمة التكييف.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">صاج استانلس:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp;يتم استخدام صاج الاستانلس في صناعة أواني الطهي والأجهزة المنزلية بسبب مقاومته العالية للصدأ والتآكل، وسهولة تنظيفه كما أن استخدامه آمن وصحى.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;</span></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">صاج الألمنيوم:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يدخل صاج الألمنيوم في صناعة هياكل الطائرات بسبب خفة وزنه وقوته العالية، مما يجعله مادة مثالية.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">صاج النحاس:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp;يتم استخدام صاج النحاس في صناعة المحولات الكهربائية بسبب توصيله الجيد للكهرباء ومقاومته للتآكل.</span></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">أهم ما يميز لوح الصاج الملون:</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح الصاج الملون له العديد من المميزات التي تجعله خيار شائع في مجموعة متنوعة من التطبيقات. إليك بعض المميزات المهمة:</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">مقاوم للتآكل: تتميز الألواح الصاجية الملونة إنها مقاومة للتآكل بفضل الطلاء الذي عليها. حيث يمنع هذا الطلاء الصدأ والتآكل الذي قد يحدث على السطح بسبب التعرض للعوامل الجوية المختلفة.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">المتانة والقوة: يتميز الصاج بقوته وصلابته، مما يجعله من أفضل المواد للاستخدام في البناء والهياكل المعدنية حيث يتميز بصلابته واستقراره.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">سهولة التركيب والتشكيل: يمكن تشكيل وقطع الألواح الصاجية الملونة بسهولة لتناسب احتياجات المشاريع المختلفة. كما أن الألواح الصاجية تتوفر بأحجام مختلفة لتناسب الاحتياجات المحددة لكل مشروع. مما يتيح لك أختيار الحجم الذي يتناسب مع المشروع الخاص بك بسهولة.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">نوع الألوان والتشطيبات: يمكنك الحصول على الألواح الصاجية الملونة بمجموعة متنوعة من الألوان والتشطيبات، مما يتيح لك تحقيق الشكل المطلوب للمشروع بالإضافة إلى الحصول على مظهر جمالي راقي وجذاب.&nbsp;</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صديقة للبيئة: من ضمن مميزات الألواح الصاجية التى ذكرناها من قبل انها مقاومه للتآكل لذلك فهي تقلل من احتياجات الصيانة، بالإضافة إلى انه يمكن إعادة تدوير الألواح الصاجية الملونة بعد نهاية عمرها الافتراضي، مما يجعلها اختيار مثالي صديق للبيئة.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تكلفة منخفضة للصيانة: نظرًا لمقاومته العالية للتآكل والصدآ، يتطلب لوح صاج ملون القليل من الصيانة مقارنةً بالمواد الأخرى، مما يوفر لك الكثير من تكاليف الصيانة على المدى الطويل.</span></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">سعر لوح صاج ملون:</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يعتمد سعر لوح الصاج الملون على عدة عوامل، بما في ذلك:</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">سمك الصاج:&nbsp;</span></strong><span style="font-size:12pt;">كلما زاد سمك الصاج، كلما زادت التكلفة عمومًا. في الأغلب الألواح السميكة تكون أكثر تكلفة بسبب استخدام كميات أكبر من المواد.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">حجم اللوح:&nbsp;</span></strong><span style="font-size:12pt;">ألواح الصاج ذات حجم كبير تكون أكثر تكلفة من الألواح الصغيرة.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">نوعية الطلاء والتشطيب:&nbsp;</span></strong><span style="font-size:12pt;">بعض الألواح الصاجية الملونة يتم طلائها بمواد خاصة لزيادة المتانة ومقاومة التآكل، وبالتالي هذا يؤثر على سعرها.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">الكمية المشتراه:&nbsp;</span></strong><span style="font-size:12pt;">عند شرائك كميات كبيرة من الألواح الصاجية عادةً ما يتيح لك الحصول على سعر أقل عن شراء كميات صغيرة. &nbsp;</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">الموقع الجغرافي:&nbsp;</span></strong><span style="font-size:12pt;">الأسعار قد تختلف بشكل كبير على حسب المناطق والبلدان المختلفة بناءً على تكاليف الشحن والضرائب والرسوم الجمركية وغيرها من العوامل المحلية التي تتغير.</span></p>
        <p><br></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لذلك يمكن أن يتراوح سعر لوح صاج ملون بين مبلغ معين للمتر المربع حسب العوامل المذكورة أعلاه. تواصل معنا الآن للحصول على مزيد من التفاصيل حول الأسعار وسيتم المتابعة معك من قبل فريق المبيعات لدينا في أسرع وقت. &nbsp;</span></p>
        <p><br></p>`
    },
    "Cold Rolled Sheets": {
        data: `<h2 dir="rtl" style="text-align: right;"><strong><span style="font-size:16pt;">لوح صاج بارد:</span></strong></h2>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح صاج بارد من ضمن أنواع الألواح المعدنية المصنوعة عادةً من الفولاذ أو الألمنيوم أو الصلب المجلفن، ويتم إنتاجه باستخدام عملية الدرفلة على البارد.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يتميز لوح صاج بارد بأن لديه سطح أكثر نعومة ودقة بالمقارنة مع الألواح المدرفلة على الساخن، نظرًا لأنها تُصنع بدرجات حرارة منخفضة مثل درجة حرارة الغرفة.</span></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">استخدامات لوح صاج بارد:</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يستخدم لوح الصاج البارد في مجموعة واسعة من التطبيقات، بما في ذلك:</span></p>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">صناعة السيارات: يُستخدم لوح صاج بارد في صناعة العديد من هياكل السيارات وأجزاء الهيكل الخارجية بسبب قوة صلابته ومتانته.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الأجهزة المنزلية: لوح صاج بارد يدخل في صناعة الأجهزة المنزلية مثل الثلاجات والغسالات والمجففات بسبب أنه مقاومته للتآكل ومن السهل تشكيله.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الصناعات الإلكترونية: يتم استخدام لوح الصاج البارد في صناعة أجهزة الكمبيوتر والأجهزة الإلكترونية الأخرى لأنه يتميز بقوته وقدرته على التشكيل بدقة عالية.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">البناءات المعدنية: يمكنك استخدام لوح الصاج في تصنيع الأبواب والنوافذ والألواح الجدارية والاعتماد عليه بشكل كبير بسبب متانته ومقاومته للتآكل.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الصناعات الصناعية العامة: يُستخدم لوح صاج بارد في صناعة المعدات الصناعية وأيضًا يدخل في صناعة أنابيب الصلب والمنتجات الصناعية الأخرى بسبب متانته.</span></p>
            </li>
        </ul>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">ما الفرق بين لوح صاج ملون ولوح صاج بارد؟</span></strong></h3>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">من حيث عملية التصنيع:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;- لوح الصاج الملون يتم تصنيعه عن طريق طلاء لوح الصاج الأساسي بطبقة من الطلاء الملون، سواء كان ذلك بطلاء بالرش أو بالغمر مما يُضفي مظهر جمالى جذاب.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;- لوح الصاج البارد يتم تصنيعه عن طريق عملية الدرفلة على البارد، عن طريق تشكيل الصفائح المعدنية بدرجات حرارة منخفضة أو في درجة حرارة الغرفة دون استخدام درجات حرارة مرتفعة.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">من حيث المظهر والتشطيب:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;- لوح الصاج الملون يأتي بتشطيب ملون يمكن أن يكون لامع أو غير لامع، كما أنه يتوفر بمجموعة واسعة من الألوان والتشطيبات.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;- لوح الصاج البارد يأتي بتشطيب غير ملون، ويكون له مظهر معدني لامع أو غير لامع على حسب المادة المستخدمة.</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">من حيث الاستخدامات:</span></strong></h4>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;- لوح الصاج الملون يُستخدم بشكل رئيسي في الصناعات التي تتطلب مظهر جمالي ملون وجذاب، مثل الواجهات الخارجية للمباني والإعلانات واللوحات الإرشادية في الطرق.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">&nbsp; &nbsp;- لوح الصاج البارد يُستخدم بشكل عام في جميع الصناعات التي تتطلب قوة ميكانيكية عالية ومتانة كبيرة، مثل هياكل السيارات والأثاث الصناعي والأجهزة الكهربائية.</span></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">أنواع لوح الصاج البارد:&nbsp;</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">هناك العديد من أنواع لوح الصاج البارد التي تختلف في الخامات والتطبيقات ومنها:</span></p>
        <p><br></p>
        <ul>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح الصاج البارد العادي: يتم تصنيعه من مادة الفولاذ بدون الحاجة إلى تشكيله أو علاجات حرارية معينة، وفي الغالب يتم استخدامه في مجموعة متنوعة من التطبيقات التي لا تتطلب خصائص ميكانيكية محددة.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح الصاج المطلي: يتم تطبيق طبقة من الزنك على سطح اللوح الصاج لزيادة مقاومته للتآكل. كما أنه يستخدم في الصناعات التي تتطلب مقاومة عالية للتآكل مثل صناعة الهياكل المعدنية وصناعة السيارات.</span></p>
            </li>
            <li dir="rtl" style="list-style-type:disc;font-size:12pt;">
                <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">لوح الصاج المطلي بالفوسفات: يتم تطبيق طبقة من مادة الفوسفات على سطح الصاج لتقوم بتحسين خواص التصاق الصاج ومدى مقاومتة للتآكل. يتم استخدام هذا النوع من الصاج في صناعة الهياكل المعدنية وأجهزة التكييف والتهوية.</span></p>
            </li>
        </ul>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">ما هي عملية الدرفلة على البارد؟&nbsp;</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">عملية الدرفلة على البارد تستخدم عادةً في صناعة الألواح المعدنية المستخدمة في مجموعة متنوعة من التطبيقات مثل صناعة السيارات، والأجهزة المنزلية، والصناعات الأخرى.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">بالإضافة إلى أن عملية الدرفلة على البارد يتم فيها تشكيل المعادن دون تسخين المعدن إلى درجات حرارة عالية مثلما يحدث في عملية الدرفلة على الساخن.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الخطوات الرئيسية في عملية الدرفلة على البارد:</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">تحضير المواد: تبدأ عملية الدرفلة بتحضير الصفائح المعدنية التي ستتم معالجتها. يجب أن تقوم بتنظيف المواد وإزالة أي شوائب قبل بدء عملية الدرفلة.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">التسوية (المعادنة): في هذه الخطوة يتم تسوية المادة المعدنية لضمان أنها تظل مسطحة ومستقرة قبل الدخول إلى آلة الدرفلة.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">الدرفلة على البارد: تتم عملية الدرفلة في درجات حرارة الغرفة أو درجات حرارة منخفضة فهي لا تطلب التسخين أو درجات حرارة عالية. يتم تمرير المادة المعدنية بين أسطوانات الضغط في آلة الدرفلة لتقوم بتشكيلها وتقليل سماكتها حسب الحاجة. بالإضافة إلى انه يتم ضبط أسطوانات الضغط بشكل دقيق ليتم تحقيق الشكل والأبعاد المطلوبة للمنتج النهائي.</span></p>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">التشطيب: بعد نهاية عملية الدرفلة، قد تأتي مرحلة التشطيب وهى مرحلة إضافية مثل التلميع أو القص لتحقيق التشطيب النهائي المطلوب بشكل صحيح.</span></p>
        <p><br></p>
        <h3 dir="rtl" style="text-align: right;"><strong><span style="font-size:14pt;">سعر لوح صاج بارد في مصر 2024:</span></strong></h3>
        <p dir="rtl" style="text-align: right;"><span style="font-size:12pt;">يعتمد سعر لوح الصاج البارد على الكثير من العوامل، ومنها:</span></p>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">سمك لوح الصاج:&nbsp;</span></strong><span style="font-size:12pt;">عندما &nbsp;يكون سمك لوح صاج بارد كبير تكون تكلفته أعلى بسبب استخدام كميات أكبر من المواد.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">التشطيب والطلاءات:</span></strong><span style="font-size:12pt;">&nbsp;إذا كان الصاج مطليً بطبقات مضادة للتآكل مثل مادة الزنك أو الفوسفات، في هذه الحالة يكون سعره أعلى بسبب التكاليف الإضافية لتلك الطبقات.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">حجم اللوح:&nbsp;</span></strong><span style="font-size:12pt;">عندما يكون حجم لوح الصاج كبير تكون أكثر تكلفة من لوح صاج صغير.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">العوامل الاقتصادية والسياسية:</span></strong><span style="font-size:12pt;">&nbsp;قد يحدث العديد من تقلبات الأسعار في السوق العالمية والتغيرات الاقتصادية والسياسية بالتالي يمكن أن تؤثر على أسعار المواد الخام وبالتالي على سعر لوح صاج بارد.</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">الكمية المشتراه:&nbsp;</span></strong><span style="font-size:12pt;">عند شرائك كميات كبيرة من لوح الصاج في هذه الحالة يمكنك الحصول على سعر أقل على عكس عند شرائك كميات صغيرة ستكون التكلفة أعلى. &nbsp;</span></h4>
        <p><br></p>
        <h4 dir="rtl" style="text-align: right;"><strong><span style="font-size:12pt;">الموقع الجغرافي:&nbsp;</span></strong><span style="font-size:12pt;">الأسعار قد تتغير بشكل كبير على حسب المناطق المختلفة بناءً على تكاليف النقل والضرائب والرسوم الجمركية وغيرها من العوامل التي تؤثر على سعر لوح الصاج.</span></h4>
        <p><br></p>
